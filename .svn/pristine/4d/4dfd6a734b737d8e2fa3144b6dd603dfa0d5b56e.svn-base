	...
	<div class="form-text">
		<form id="al_engine">
			...
			<div class="gform">
				...
				<div style="border: 1px dotted grey !important; padding: 20px; margin: 0 0 20px 0">
					Global settings to control the behaviour of your chosen model. Using standard model names like gpt-4 or gpt-3.5-turbo will default to the very latest default version of each model. We have also included experimental/preview versions like 'gpt-4-1106-preview' and 'gpt-4-vision-preview' for testing. Whether you have access to all models is out of our control as this is decided by OpenAI and new features tend to be rolled out gradually. 
					<ul>
