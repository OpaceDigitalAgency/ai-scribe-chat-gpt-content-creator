 ...
 * Plugin Name: 		AI Scribe: ChatGPT SEO Content Creator & Writer, Blog Writer & SEO Assistant (GPT 3 & 4)
 * Description: 		AI Scribe: Free Plugin, ChatGPT, AI, SEO, Content Creator & Writer (Blog Writer), Keyword Research, Title Suggestions, Editable Prompts, OpenAI, GPT, Auto Article Writer, SEO Analysis, Article Evaluation, GPT-3, GPT-4, 16K, 32K. Compatible with Yoast SEO, Rank Math, AIOSEO & SEOPress. Free Plugin - No hidden costs or paid add-ons.  
 * Plugin URI: 			https://www.opace.co.uk
 * Text Domain: 		ai-scribe-gpt-article-builder
 * Tags: 				AI, ChatGPT, SEO, Content Creator, Content Writer, Blog Writer, Content Generator, Content Writer, Blog Writer, OpenAI, GPT-3, GPT-4, GPT-3.5, GPT-3.5-Turbo, ChatGPT-3, ChatGPT-4, 16K, 32K, Text Creator, Blog Creator, Blog Builder, Article Writer, Content Marketing, Free, GPT, OpenAI, Keyword Research
...
Does the article provide an original, interesting and engaging perspective on the topic?',
	...
	*/
	public function suggest_content() {
		...
		// v1.2.4 update to reduce timeout issues on all models, limits added back in place following v1.2.3 update
