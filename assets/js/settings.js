jQuery(document).ready(function () {
    ...
    function toggleParameterVisibility() {
        ...
        console.log('Selected model:', selectedModel, 'isO3:', isO3, 'isOpenAI:', isOpenAI, 'isAnthropic:', isAnthropic);
        ...
        if (isO3) {
            ...
            console.log('Showing reasoning effort dropdown for o3 model');
