...
class AI_Scribe_Admin_Service {
	...
	private function localize_main_script_data() {
		...
		$localized_data = array(
			...
			'hubSettingsUrl'      => admin_url( 'admin.php?page=ai-core-settings' ),
	...
	private function get_js_i18n() {
		return array(
			...
			'modelListRefreshed'        => __( 'Model list refreshed', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ),
			/* translators: %d: Number of available AI models loaded. */
			'modelsLoadedCatalogueOnly' => __( '%d available models loaded. This refresh updates the catalogue only; key validation is shown separately.', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ),
			'openHubSettings'            => __( 'Open Opace AI Hub settings', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ),
			'stepCouldNotFinish'         => __( 'This step could not finish', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ),
			'providerStatusValidated'    => __( 'Saved and validated', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ),
			'providerStatusInvalid'      => __( 'Saved but invalid', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ),
			'providerStatusUntested'     => __( 'Saved, not yet tested', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ),
			'providerStatusMissing'      => __( 'Not configured', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ),
			/* translators: 1: Saved AI model name. 2: AI provider name. */
			'savedModelKeyInvalid'      => __( 'Saved model “%1$s” was retained. Its %2$s key is saved but invalid. Fix or replace it in Opace AI Hub before generating.', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ),
			/* translators: 1: Saved AI model name. 2: AI provider name. */
			'savedModelKeyUnchecked'    => __( 'Saved model “%1$s” was retained. Its %2$s key is saved, but has not yet been tested. Use Test Key in Opace AI Hub when you want to confirm it.', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ),
			/* translators: 1: Saved AI model name. 2: AI provider name. */
			...
			'savedKeyInvalidSuffix'     => __( 'saved but invalid', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ),
			'savedKeyUncheckedSuffix'   => __( 'saved, not yet tested', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ),
