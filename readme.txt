...
Support for GPT-4.5, OpenAI 3o, Anthropic Claude Sonnet 4 & Opus 4, and GPT-4o image generation - Access to the latest and most advanced AI models for superior content generation with enhanced reasoning capabilities and improved output quality.
...
**Custom Instructions**
These have been modified so that there are now three-levels of custom instructions, i.e. the “behind the scenes” instructions that gets sent with your prompts:
* Standard Mode
* Humanizer Mode
* Humanizer with Personality Mode
...
= 1.2.4 =
* Tested with with WordPress version 6.4.1.
...
* **Enhanced Image Generation:** Switched from DALLE-3 to GPT-4o images as the default and only option
* **Dual API Support:** Added support for both OpenAI and Anthropic API keys with intelligent provider switching
* **Improved UX:** Updated settings interface with provider-specific sections and dynamic parameter visibility
