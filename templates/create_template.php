		...
		<?php if ( $available ) : ?>
			...
			<details class="image-override-panel" data-testid="image-override-panel">
				...
				<div class="image-override-grid" data-testid="image-override-fields">
					<label><?php esc_html_e( 'Visual style', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?><select class="form-control" data-image-option="style" disabled><option><?php esc_html_e( 'Photorealistic', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Cinematic lighting', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Watercolour painting', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Oil painting', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Pencil sketch', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Charcoal drawing', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Line art', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Vector illustration', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Cartoon illustration', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Hand-drawn sketch', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Pop art', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Retro 80s', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Cyberpunk', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Fantasy art', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Surrealist', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Minimalist', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( '3D render', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Monochrome', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Impressionist', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option><?php esc_html_e( 'Low-poly', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option></select></label>
					<label><?php esc_html_e( 'Size', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?><select class="form-control" data-image-option="size" disabled><option value="auto"><?php esc_html_e( 'Auto', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option value="1024x1024"><?php esc_html_e( 'Square', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option value="1536x1024"><?php esc_html_e( 'Landscape', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option value="1024x1536"><?php esc_html_e( 'Portrait', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option></select></label>
					<label><?php esc_html_e( 'Quality', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?><select class="form-control" data-image-option="quality" disabled><option value="low"><?php esc_html_e( 'Low', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option value="medium"><?php esc_html_e( 'Medium', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option value="high"><?php esc_html_e( 'High', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option></select></label>
					...
					<label><?php esc_html_e( 'Background', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?><select class="form-control" data-image-option="background" disabled><option value="auto"><?php esc_html_e( 'Auto', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option value="opaque"><?php esc_html_e( 'Opaque', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option><option value="transparent"><?php esc_html_e( 'Transparent', 'ai-scribe-the-chatgpt-powered-seo-content-creation-wizard' ); ?></option></select></label>
				</div>
