...
<div class="shortcodes-content" style="padding: 30px; margin: 0; width: 100%;">
	<h1 class="page-title">Saved Shortcodes</h1>
	<table class="widefat fixed modern-table" cellspacing="0" style="width: 100%; max-width: none;">
	<thead>
	<?php
	global $wpdb;
